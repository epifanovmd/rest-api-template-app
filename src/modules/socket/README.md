...
Более 40 событий, включая: `authenticated`, `message:new`, `message:updated`, `message:deleted`, `chat:created`, `chat:typing`, `chat:unread`, `call:incoming`, `call:ended`, `poll:voted`, `contact:request`, `e2e:prekeys-low`, `push:settings-changed`, `user:privileges-changed` и др.
