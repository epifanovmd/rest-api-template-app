...
export function RegisterRoutes(router: KoaRouter) {
  ...
  router.get(
    ...
    async function FileController_getFileById(context: any, next: any) {
      ...
      const controller: any = await container.get<FileController>(
        FileController,
      );
      if (typeof controller["setStatus"] === "function") {
        controller.setStatus(undefined);
      ...
      const promise = controller.getFileById.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.post(
    ...
    async function FileController_uploadFile(context: any, next: any) {
      ...
      const promise = controller.uploadFile.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
